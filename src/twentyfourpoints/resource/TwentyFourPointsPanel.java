...
public class TwentyFourPointsPanel extends JPanel {
	 ...
	 * 
	 * @return A boolean value specifying if numbers of the expression matches the
	...
	public boolean correctNumbers() {
		...
		// Each token is returned as a string that can be used to make an Integer
		// object.
	 ...
	 * equal to 24. Converts this infix expression into a postfix form, and
